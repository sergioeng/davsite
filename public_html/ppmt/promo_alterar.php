...
?>
			<tr bgcolor="<?php echo $color ?>">
				...
				<td><input class="submit_table" type="button" value="Alterar" onClick="javascript:document.location.href=('promo_alterar_inclui.php?id=<?php echo $lista["promo_id"]?>');" /></td>
  			</tr>
<?php	}
