...
function MM_validateForm() { //v4.0
  if (document.getElementById){
    ...
    } if (errors) alert('Não foi possível enviar o formulário. Preencha todos os campos!\n'+errors);
    document.MM_returnValue = (errors == '');
} }

function verifica() {
if(document.getElementById('radio1').checked==false && document.getElementById('radio2').checked==false) {
alert("Informe se seu equipamento é próprio ou alugado.");
return false;
}
}
//validação do input radio
